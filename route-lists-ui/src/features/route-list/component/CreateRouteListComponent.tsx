...
import { CreateRouteListComponent } from '../../../app/models/CreateRouteListComponent';
import Spinner from '../../../app/components/Spinner';
import ValidationErrors from '../../../app/components/ValidationErrors';

export default observer(function CreateRouteListComponent() {
    ...
    const [data, setData] = useState<CreateRouteListComponent>({
        routeListId: 0,
        code: '',
        name: '',
        factoryNumber: '',
    ...
    async function handleSubmit() {
        try {
            ...
            await agent.RouteListComponents.create(data);
                    ...
                    <div>
                        ...
                        <Form onSubmit={handleSubmit} autoComplete='off'>
                            ...
                            <Form.Field>
                                ...
                                <Form.TextArea name='accompanyingDocument' value={data.accompanyingDocument ?? ''} onChange={handleInputChange} />
                            </Form.Field>

                            <Form.Field>
                                <label>Количество</label>
                                <Form.Input name='count' type='number' value={data.count} onChange={handleInputChange} />
                            </Form.Field>
