...
import { CreateRouteListModification } from '../../../app/models/CreateRouteListModification';
import SelectExecutor from '../../../app/components/SelectExecutor';
import { Executor } from '../../../app/models/Executor';

export default observer(function CreateRouteListModification() {
    ...
    const { setNeedToResetParameters } = routeListModificationStore;
    ...
    const [data, setData] = useState<CreateRouteListModification>({
        routeListId: 0,
        documentNumber: '',
        executorId: 0,
        ids: []
    ...
    async function handleSubmit() {
        ...
        try {
            ...
            await agent.RouteListModifications.create(data);
                    ...
                    <div>
                        ...
                        <Form onSubmit={handleSubmit} autoComplete='off'>
                            ...
                            <Form.Field>
                                ...
                                <Form.Input name='documentNumber' value={data.documentNumber} onChange={handleInputChange} />
                            </Form.Field>
